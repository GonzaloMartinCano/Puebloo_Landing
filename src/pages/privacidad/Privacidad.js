...
const SiteName = () => <img src={logo} alt='Puebloo' style={{ height: '1em' }} className='d-inline-block mx-1' />

const politicasdeprivacidad = () => {
    return (
        <div className='privacidad-container '>
            <main className='container'>
                <div className='bg-white p-8 px-2 rounded shadow'>
                    ...
                    <p>
                        <SiteName className='mx-1' /> pudiera contener en laces a otros sitios que pudieran ser
